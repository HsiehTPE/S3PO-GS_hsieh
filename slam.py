...
if __name__ == "__main__":
    ...
    # Optional arguments for ablation study, by hsieh
    parser.add_argument("--ns", type=int, default=None, help="no single")
    parser.add_argument("--sh", type=int, default=0, help="spherical harmonics degree") 
